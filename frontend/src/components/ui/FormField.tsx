...
export const inputCls =
  "w-full px-3 py-2.5 rounded-xl border border-[#D0D5DD] text-sm text-[#101828] placeholder:text-[#667085] bg-white focus:outline-none focus:ring-2 focus:ring-[#4F7CFF]/25 focus:border-[#4F7CFF] transition-all";

export const inputErrorCls =
  "w-full px-3 py-2.5 rounded-xl border border-[#E5484D] text-sm text-[#101828] placeholder:text-[#667085] bg-white focus:outline-none focus:ring-2 focus:ring-[#E5484D]/20 focus:border-[#E5484D] transition-all";
...
export function FormField({ label, error, required, hint, children }: FieldProps) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      {children}
      {hint && !error && <p className="text-[10px] text-[#667085]">{hint}</p>}
    ...
    if (leftIcon) {
      return (
        <div className="relative">
          <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#667085]">{leftIcon}</span>
          <input
            ref={ref}
  ...
  return (
    <div className="relative">
      ...
      <button
        type="button"
        onClick={() => setShow((s) => !s)}
        className="absolute right-3 top-1/2 -translate-y-1/2 text-[#667085] hover:text-[#667085] transition-colors"
      >
